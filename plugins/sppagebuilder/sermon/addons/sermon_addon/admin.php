 ...
 * @author JoomShaper [http://www.joomshaper.com](http://www.joomshaper.com)
...
SpAddonsConfig::addonConfig([
        'type'=>'content',
        'addon_name'=>'sermon_addon',
        'title'=> 'Sermon Addon',
        'desc'=> 'Sermon addon for SP Page Builder - Articles by Category',
        'icon'=>JURI::root() . 'plugins/sppagebuilder/sermon/addons/sermon_addon/assets/images/icon.png',
        'category'=>'Sermon List',
        'settings' => [
        'source' => [
