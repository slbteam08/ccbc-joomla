                ...
                'general' => array(
                    ...
                    'decoration' => array(
                        ...
                        'values' => array(
                            ...
                            'uk-heading-background' => Text::_('Background'),
                        ),
                        'std' => '',
                    ),
                    'decoration_background_padding' => array(
                        'type' => 'padding',
                        'title' => JText::_('COM_SPPAGEBUILDER_GLOBAL_PADDING'),
                        'desc' => JText::_('COM_SPPAGEBUILDER_GLOBAL_PADDING_DESC'),
                        'std' => '',
                        'depends' => array(
                            array('decoration', '=', 'uk-heading-background'),
                        )
                    ),
                    'decoration_background_color' => array(
                        'type' => 'color',
                        'title' => Text::_('Decoration Background Color'),
                        'depends' => array(array('decoration', '=', 'uk-heading-background')),
                    ),
                    ...
                    'decoration_style' => array(
                        'type' => 'select',
                        'title' => Text::_('Border Style'),
                        'values' => array(
                            '' => Text::_('None'),
                            'solid' => Text::_('Solid'),
