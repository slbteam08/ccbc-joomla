...
class SppagebuilderAddonUKHeading extends SppagebuilderAddons {
	...
	public function render() {
		...
		if ( $title ) {
			...
			if ( $heading_decoration == ' uk-heading-line' || $text_background ) {
                ...
                if ($heading_decoration == ' uk-heading-background') {
                    $output .= '<span class="uk-heading-background-inner">';
                }
                if ($use_highlight) {
	...
	public function css() {
        ...
        if ($heading_decoration == 'uk-heading-background') {
            $decoration_color .= (isset($settings->decoration_background_padding) && $settings->decoration_background_padding) ? 'padding: '.$settings->decoration_background_padding . ';' : '';
            $decoration_color .= (isset($settings->decoration_style) && $settings->decoration_style) ? 'border-style: '.$settings->decoration_style . ';' : '';
            $decoration_color .= (isset($settings->decoration_background_color) && $settings->decoration_background_color) ? 'background-color: '.$settings->decoration_background_color . ';' : '';
            $css .= $addon_id . ' .uk-title > .uk-heading-background-inner {' . $decoration_color . '}';
        }
