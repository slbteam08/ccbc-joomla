...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uisubnav',
		'title' => \Joomla\CMS\Language\Text::_('UI Subnav'),
		'desc' => \Joomla\CMS\Language\Text::_('Defines different styles for a sub navigation.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uisubnav/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'separator_subnav_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Subnav'),
				),
				'style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Select the list style and add larger padding between items.'),
					'values' => array(
