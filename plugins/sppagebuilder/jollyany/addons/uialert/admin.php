...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uialert',
		'title' => \Joomla\CMS\Language\Text::_('UI Alert'),
		'desc' => \Joomla\CMS\Language\Text::_('Display success, warning and error messages.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uialert/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'title_heading_color' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Select the text color. If the background option is selected, you can use Light or Dark color text mode to inverse the text style.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
				...
				'separator_alert_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Alert'),
				),
				'style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('By selecting a style, you can apply different colored for alert add-on.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Default'),
				...
				'margin' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Set the vertical margin. Note: The first element\'s bottom margin are always removed. Define those in the grid settings instead'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Keep existing'),
						'uk-margin-small' => \Joomla\CMS\Language\Text::_('Small'),
						'uk-margin' => \Joomla\CMS\Language\Text::_('Default'),
