...
SpAddonsConfig::addonConfig(
  array(
    ...
    'title' => \Joomla\CMS\Language\Text::_('UI Button Group'),
    'desc' => \Joomla\CMS\Language\Text::_('To create a button group.'),
    'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uibuttongroup/assets/images/icon.png',
    'category' => 'Jollyany',
    'attr' => array(
      'general' => array(
        'admin_label' => array(
        ...
        'alignment' => array(
          ...
          'desc' => \Joomla\CMS\Language\Text::_('Define the horizontal alignment of flex items and distribute the space between them. '),
          'values' => array(
              '' => \Joomla\CMS\Language\Text::_('None'),
