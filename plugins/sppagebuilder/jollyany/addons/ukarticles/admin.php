...
array(
	...
	'attr'=>array(
		'general' => array(
            ...
            'ebcatid' => [
                'type' => 'select',
                'title' => JText::_('Select Categories'),
                'desc' => JText::_('Select an EasyBlog category from the list.'),
                'depends'=>array('resource'=>'easyblog'),
                'values' => EasyBlog::getCategories(),
                'multiple' => false,
                'std' => '0',
            ],
            'ebtagids' => [
                'type' => 'select',
                'title' => JText::_('Select Tags'),
                'desc' => JText::_('Select EasyBlog tags from the list. All items from this tag will be apear automatically.'),
                'depends'=>array('resource'=>'easyblog'),
                'values' => EasyBlog::getTags(),
                'multiple' => true,
            ],
            'eb_post_type' => [
                'type' => 'select',
                'title' => JText::_('Post Type'),
                'desc' => JText::_('Select a post type which you want to show.'),
                'depends'=>array('resource'=>'easyblog'),
                'values' => EasyBlog::getPostType(),
                'std' => 'latest'
            ],
        ...
        'lead-options' => array(
            ...
            'lead_overlay_color'=>array(
                ...
                'depends'=>array(
                    array('lead_layout', '=', 'thumbnail'),
                    array('lead_overlay_type', '=', 'color')
                ),
            ),
            'lead_overlay_gradient'=>array(
                'type'=>'gradient',
                ...
                'depends'=>array(
                    array('lead_layout', '=', 'thumbnail'),
                    array('lead_overlay_type', '=', 'gradient')
                ),
            ),
            ...
            'lead_card_divider_style'=>array(
                'type'=>'select',
                'title'=>JText::_('Card Divider Style'),
                'values'=>array(
                    ''=>JText::_('Style 1'),
                    'uk_divider_2'=>JText::_('Style 2'),
                ),
                'std'=>'',
                'depends' => array(
                    array('lead_card_divider', '=', '1'),
                ),
            ),
            ...
            'lead_text_margin_top'=>array(
                'type'=>'slider',
                'title'=>JText::_('Content Margin Top'),
                'placeholder'=>'10',
                'max'=> 400,
            ),

            'lead_text_margin_bottom'=>array(
                'type'=>'slider',
                'title'=>JText::_('Content Margin Bottom'),
                'placeholder'=>'10',
                'max'=> 400,
            ),
            ...
            'lead_button_size' => array(
                ...
                'values' => array(
                    '' => JText::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_SIZE_DEFAULT'),
                    'small' => JText::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_SIZE_SMALL'),
                    'large' => JText::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_SIZE_LARGE'),
                ),
                'depends'=>array('lead_show_readmore'=>'1')
            ),
