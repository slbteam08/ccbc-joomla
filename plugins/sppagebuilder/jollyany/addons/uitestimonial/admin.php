...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uitestimonial',
		'title' => \Joomla\CMS\Language\Text::_('UI Testimonial'),
		'desc' => \Joomla\CMS\Language\Text::_('Nice things clients say about us'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uitestimonial/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'company' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Company'),
					'std' =>  'Customer',
				),
				'avatar' => array(
					'type' => 'media',
					'title' => \Joomla\CMS\Language\Text::_('Avatar'),
					'desc'=>\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_IMAGE_SELECT_DESC'),
					'show_input' => true,
				...
				'avatar_width' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Avatar width'),
					'std' => 90,
					'min' => 16,
					'max' => 128,
					'depends' => array(array('avatar', '!=', '')),
				),
				'avatar_shape' => array(
					'type' => 'select',
