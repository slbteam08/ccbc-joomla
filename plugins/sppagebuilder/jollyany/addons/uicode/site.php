...
class SppagebuilderAddonUiCode extends SppagebuilderAddons {
	...
	public function scripts() {
		return array(
			\Joomla\CMS\Uri\Uri::base( true ) . '/plugins/sppagebuilder/jollyany/assets/js/highlight.min.js',
		);
	}
	public function stylesheets() {
		return array(
			\Joomla\CMS\Uri\Uri::base( true ) . '/plugins/sppagebuilder/jollyany/assets/css/monokai.css',
		);
	}
}
