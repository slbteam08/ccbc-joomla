...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uicode',
		'title' => \Joomla\CMS\Language\Text::_('Ui Code'),
		'desc' => \Joomla\CMS\Language\Text::_('Syntax highlighting for the Web'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uicode/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
