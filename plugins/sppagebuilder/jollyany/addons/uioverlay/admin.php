...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('UI Overlay'),
		'desc' => \Joomla\CMS\Language\Text::_('Create an image overlay, which comes in different styles.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uioverlay/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'label_text' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('To position a badge inside Overlay.'),
					'std' => '',
				),
				'label_styles' => array(
					'type' => 'select',
				...
				'link_text' => array(
					...
					'placeholder' => \Joomla\CMS\Language\Text::_('Read more'),
					'desc' => \Joomla\CMS\Language\Text::_('Enter the text for the link.'),
					'std' => 'Read more',
					'depends' => array(array('title_link', '!=', '')),
				),
				'image_hover' => array(
				...
				'image_transition' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Transition'),
					'desc' => \Joomla\CMS\Language\Text::_('Select an image transition. If the hover image is set, the transition takes place between the two images. If None is selected, the hover image fades in.'),
					'values' => array(
				...
				'button_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Set the link style.'),
					'values' => array(
