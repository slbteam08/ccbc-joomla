...
SpAddonsConfig::addonConfig(
    array(
      'type' => 'content',
      'addon_name' => 'uitoggle',
      'title' => \Joomla\CMS\Language\Text::_('UI Toggle'),
      'desc' => \Joomla\CMS\Language\Text::_('Hide, switch or change the appearance of different contents through a toggle.'),
      'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uitoggle/assets/images/icon.png',
      'category' => 'Jollyany',
      'attr' => array(
          'general' => array(
            'admin_label' => array(
            ...
            'toggle_type' => array(
                'type' => 'select',
                'title' => \Joomla\CMS\Language\Text::_('Toogle Content Type'),
                'desc' => \Joomla\CMS\Language\Text::_('Select Toogle type, change the appearance of different contents through a toggle.'),
                'values' => array(
                    '' => \Joomla\CMS\Language\Text::_('Switcher'),
                    'toogle_text' => \Joomla\CMS\Language\Text::_('Button'),
                ),
                'std' => '',
            ),
            'before_toggle' => array(
                'type' => 'text',
                'title' => \Joomla\CMS\Language\Text::_('Text before'),
                'std' => 'Annual',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'after_toggle' => array(
                'type' => 'text',
                'title' => \Joomla\CMS\Language\Text::_('Text after'),
                'std' => 'Lifetime',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'toggle_align' => array(
                ...
                'desc' => \Joomla\CMS\Language\Text::_('These classes define the alignment of flex items.'),
                'values' => array(
                    'uk-flex-left' => \Joomla\CMS\Language\Text::_('Left'),
                    'uk-flex-center' => \Joomla\CMS\Language\Text::_('Center'),
                    'uk-flex-right' => \Joomla\CMS\Language\Text::_('Right'),
                ),
                'std' => 'uk-flex-center',
            ),
            'toggle_animation' => array(
                'type' => 'select',
                'title' => \Joomla\CMS\Language\Text::_('Toggle Animation'),
                'desc' => \Joomla\CMS\Language\Text::_('Add animations to items when toggling between them.'),
                'values' => array(
            ...
            'toggle_color' => array(
                'type' => 'color',
                'title' => \Joomla\CMS\Language\Text::_('Onclick Background'),
                'desc' => \Joomla\CMS\Language\Text::_('Background color for toggle color'),
                'std' => '#1e87f0',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'visible_text' => array(
                'type' => 'editor',
                'title' => \Joomla\CMS\Language\Text::_('Visible Content'),
                'desc' => \Joomla\CMS\Language\Text::_('Content visible before clicking toggle button'),
                'std' => '',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'hidden_text' => array(
                'type' => 'editor',
                'title' => \Joomla\CMS\Language\Text::_('Hidden Content'),
                'desc' => \Joomla\CMS\Language\Text::_('Content display after clicking on toggle button'),
                'std' => '',
                'depends' => array(array('toggle_type', '!=', 'toogle_text')),
            ),
            'button_title' => array(
                'type' => 'text',
                'title' => \Joomla\CMS\Language\Text::_('Button text'),
                'std' => 'Read more',
                'depends' => array(array('toggle_type', '!=', '')),
            ),
            'button_style' => array(
                'type' => 'select',
                'title' => \Joomla\CMS\Language\Text::_('Style'),
            ...
            'button_hidden_text' => array(
                'type' => 'textarea',
                'title' => \Joomla\CMS\Language\Text::_('Content on click'),
                'desc' => \Joomla\CMS\Language\Text::_('Content display after clicking on text button'),
                'std' => '',
                'depends' => array(array('toggle_type', '!=', '')),
            ),
