        ...
        array(
            ...
            'attr' => array(
                'general' => array(
                    ...
                    'image_dark' => array(
                        'type' => 'media',
                        'title' => Text::_('Select Image Dark Mode'),
                        'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_IMAGE_SELECT_DESC'),
                        'show_input' => true,
                        'std'=> array(
                            'src' => 'https://sppagebuilder.com/addons/image/image1.jpg',
                        ...
                        'depends' => array(array('dark_mode', '=', 1)),
                    ),
                    ...
                    'image_webp_dark' => array(
                        'type' => 'media',
                        'title' => Text::_('Select WebP Image Dark Mode'),
                        'show_input' => true,
                        'depends' => array(array('image_webp_enable', '=', 1), array('dark_mode', '=', 1)),
                    ),
                    'alt_text' => array(
                        'type' => 'text',
