...
class SppagebuilderAddonUitext extends SppagebuilderAddons {
	...
	public function render() {
		...
		$output .= '<div class="tz-content' . $content_cls . '">';
		$output .= $content;
		$output .= '</div>';
		$output .= '</div>';
	...
	public function css() {
		...
		if ( empty( $text_color ) && $custom_title_color ) {
			$css .= '#sppb-addon-' . $this->addon->id . ' .ui-text .tz-content{ ' . $custom_title_color . ' }';
		}
