...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('UI Light Gallery'),
		'desc' => \Joomla\CMS\Language\Text::_('A customizable, modular, responsive, lightbox gallery addon for SP Pagebuilder.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uilightgallery/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'ui_simple_gallery_item' => array(
					...
					'attr' => array(
						...
						'media_thumb' => array(
							...
							'desc' => \Joomla\CMS\Language\Text::_('Add your thumbnail image for item, if thumbnail image are empty, the main image will be added as thumbnail image. '),
							'placeholder' => 'http://www.example.com/my-photo.jpg',
						),
					),
				),
				...
				'gallery_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Gallery Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Present your gallery with different styles.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Default'),
						'comment' => \Joomla\CMS\Language\Text::_('Facebook Comment Box'),
						'fixed-size' => \Joomla\CMS\Language\Text::_('Fixed Size'),
					),
					'std' => '',
				),
				'size_width' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Fixed Width'),
					'min' => 400,
					'max' => 1200,
					'desc' => \Joomla\CMS\Language\Text::_('Define the fixed width for light gallery'),
					'std' => 700,
					'depends' => array(
				...
				'size_height' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Fixed Height'),
					'min' => 400,
					'max' => 1200,
					'desc' => \Joomla\CMS\Language\Text::_('Define the fixed height for light gallery'),
					'std' => 700,
					'depends' => array(
						array('gallery_style', '=', 'fixed-size'),
					),
				...
				'transition_mode' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Transition Mode'),
					'desc' => \Joomla\CMS\Language\Text::_('Lightgallery comes with a numerous number of beautiful built in animations. You can change the type of transitions image below'),
					'values' => array(
						'lg-fade' => \Joomla\CMS\Language\Text::_('Fade'),
						'lg-zoom-in' => \Joomla\CMS\Language\Text::_('Zoom In'),
						'lg-zoom-in-big' => \Joomla\CMS\Language\Text::_('Zoom In Big'),
						'lg-zoom-out' => \Joomla\CMS\Language\Text::_('Zoom Out'),
						'lg-zoom-out-big' => \Joomla\CMS\Language\Text::_('Zoom Out Big'),
						'lg-zoom-out-in' => \Joomla\CMS\Language\Text::_('Zoom Out In'),
						'lg-zoom-in-out' => \Joomla\CMS\Language\Text::_('Zoom In Out'),
						'lg-soft-zoom' => \Joomla\CMS\Language\Text::_('Soft Zoom'),
						'lg-scale-up' => \Joomla\CMS\Language\Text::_('Scale Up'),
						'lg-slide-circular' => \Joomla\CMS\Language\Text::_('Slide Circular'),
						'lg-slide-circular-vertical' => \Joomla\CMS\Language\Text::_('Slide Circular Vertical'),
						'lg-slide-vertical' => \Joomla\CMS\Language\Text::_('Slide Vertical'),
						'lg-slide-vertical-growth' => \Joomla\CMS\Language\Text::_('Slide Vertical Growth'),
						'lg-slide-skew-only' => \Joomla\CMS\Language\Text::_('Slide Skew Only'),
						'lg-slide-skew-only-rev' => \Joomla\CMS\Language\Text::_('Slide Skew Only Rev'),
						'lg-slide-skew-only-y' => \Joomla\CMS\Language\Text::_('Slide Skew Only Y'),
						'lg-slide-skew-only-y-rev' => \Joomla\CMS\Language\Text::_('Slide Skew Only Rev'),
						'lg-slide-skew' => \Joomla\CMS\Language\Text::_('Slide Skew'),
						'lg-slide-skew-rev' => \Joomla\CMS\Language\Text::_('Slide Skew Rev'),
						'lg-slide-skew-cross' => \Joomla\CMS\Language\Text::_('Slide Skew Cross'),
						'lg-slide-skew-cross-rev' => \Joomla\CMS\Language\Text::_('Slide Skew Cross Rev'),
						'lg-slide-skew-ver' => \Joomla\CMS\Language\Text::_('Slide Skew Ver'),
						'lg-slide-skew-ver-rev' => \Joomla\CMS\Language\Text::_('Slide Skew Ver Rev'),
						'lg-slide-skew-ver-cross' => \Joomla\CMS\Language\Text::_('Slide Skew Ver Cross'),
						'lg-slide-skew-ver-cross-rev' => \Joomla\CMS\Language\Text::_('Slide Skew Ver Cross Rev'),
						'lg-lollipop' => \Joomla\CMS\Language\Text::_('Lollipop'),
						'lg-lollipop-rev' => \Joomla\CMS\Language\Text::_('Lollipop Rev'),
						'lg-rotate' => \Joomla\CMS\Language\Text::_('Rotate'),
						'lg-rotate-rev' => \Joomla\CMS\Language\Text::_('Rotate Rev'),
						'lg-tube' => \Joomla\CMS\Language\Text::_('Tube'),
					),
					'std' => 'lg-fade',
				),
				...
				'show_caption' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Image Captions'),
					'desc' => \Joomla\CMS\Language\Text::_('Show title and image content as caption for images when opening light gallery'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_thumbnail' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Thumbnails'),
					'desc' => \Joomla\CMS\Language\Text::_('Show or hide thumbnail below gallerry'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_toogle_thumbnail' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Toogle Thumbnails'),
					'desc' => \Joomla\CMS\Language\Text::_('Whether to display thumbnail toggle button.'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_hash' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Hash Feature'),
					'desc' => \Joomla\CMS\Language\Text::_('Hash plugin lets you to provide unique url for each gallery images. '),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_share_button' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Share Icon'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_zoom_button' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Zoom Icon'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_autoplay_button' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Autoplay Icon'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'show_fullscreen_button' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show Fullscreen Icon'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'icon_transition' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Select a transition for the icon when it appears on hover.'),
					'values' => array(
				...
				'meta_transition' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Transition'),
					'desc' => \Joomla\CMS\Language\Text::_('Select a transition for the meta when the overlay appears on hover.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
						'fade' => \Joomla\CMS\Language\Text::_('Fade'),
						'scale-up' => \Joomla\CMS\Language\Text::_('Scale Up'),
