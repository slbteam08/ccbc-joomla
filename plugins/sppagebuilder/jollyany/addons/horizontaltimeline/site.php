...
class SppagebuilderAddonHorizontalTimeline extends SppagebuilderAddons {
  ...
  "mouseDrag": true
    ...
    public function css() {
        ...
        if (isset($settings->date_margin_top->md)) $settings->date_margin_top = $settings->date_margin_top->md;
        $date_style .= (isset($settings->date_margin_top) && $settings->date_margin_top) ? 'margin-top:'.$settings->date_margin_top . 'px;' : '';
        if (isset($settings->date_margin_bottom->md)) $settings->date_margin_bottom = $settings->date_margin_bottom->md;
