...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('UI Filter Gallery'),
		...
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uigallery/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'all_control' => array(
					'type' => 'text',
					'std' => 'All',
					'title' => \Joomla\CMS\Language\Text::_('Replace All tag'),
					'desc' => \Joomla\CMS\Language\Text::_('Add your text to replace the \'All\' tag title'),
					'depends' => array('enable_filter' => 1),
				),
				'positions' => array(
					'type' => 'select',
