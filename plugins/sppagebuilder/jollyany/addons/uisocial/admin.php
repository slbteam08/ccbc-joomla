...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uisocial',
		'title' => \Joomla\CMS\Language\Text::_('UI Social'),
		'desc' => \Joomla\CMS\Language\Text::_('Defines different styles for a sub navigation.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uisocial/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'ui_subnav_items' => array(
					...
					'attr' => array(
                        ...
                        'color_hover' => array(
                            'type' => 'color',
                            'title' => \Joomla\CMS\Language\Text::_('Hover Color'),
                            'std' => '#3d3d3d',
                        ),
                        'background_hover' => array(
                            'type' => 'color',
                            'title' => \Joomla\CMS\Language\Text::_('Hover Background'),
                            'std' => '#f5f5f5',
                        ),
					),
				),
                ...
                'social_style' => array(
                    'type' => 'select',
                    'title' => \Joomla\CMS\Language\Text::_('Social Style'),
                    'values' => array(
                        '' => \Joomla\CMS\Language\Text::_('Default'),
                        'magazine' => \Joomla\CMS\Language\Text::_('Magazine'),
                    ),
                    'std' => '',
                ),
				'target' => array(
				...
				'link_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Link Style'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Default'),
						...
						'link-reset' => \Joomla\CMS\Language\Text::_('Link Reset'),
					),
					'std' => '',
                    'depends' => array(
                ...
                'columns_large_desktop' => array(
                    'type' => 'select',
                    'title' => \Joomla\CMS\Language\Text::_('Columns Large Desktop'),
                    'desc' => \Joomla\CMS\Language\Text::_('Set the grid gutter width.'),
                    'values' => array(
                        'auto' => \Joomla\CMS\Language\Text::_('Auto'),
                        '1-1' => \Joomla\CMS\Language\Text::_('1 Column'),
                        '1-2' => \Joomla\CMS\Language\Text::_('2 Columns'),
                        '1-3' => \Joomla\CMS\Language\Text::_('3 Columns'),
                        '1-4' => \Joomla\CMS\Language\Text::_('4 Columns'),
                        '1-5' => \Joomla\CMS\Language\Text::_('5 Columns'),
                        '1-6' => \Joomla\CMS\Language\Text::_('6 Columns'),
                    ),
                    'std' => 'auto',
                ),
                'columns_desktop' => array(
                    'type' => 'select',
                    'title' => \Joomla\CMS\Language\Text::_('Columns Desktop'),
                    'desc' => \Joomla\CMS\Language\Text::_('Set the grid gutter width.'),
                    'values' => array(
                        'auto' => \Joomla\CMS\Language\Text::_('Auto'),
                        '1-1' => \Joomla\CMS\Language\Text::_('1 Column'),
                ...
                'columns_laptop' => array(
                    'type' => 'select',
                    'title' => \Joomla\CMS\Language\Text::_('Columns Laptop'),
                    'desc' => \Joomla\CMS\Language\Text::_('Set the grid gutter width.'),
                    'values' => array(
                        'auto' => \Joomla\CMS\Language\Text::_('Auto'),
                        '1-1' => \Joomla\CMS\Language\Text::_('1 Column'),
                ...
                'columns_tablet' => array(
                    'type' => 'select',
                    'title' => \Joomla\CMS\Language\Text::_('Columns Tablet'),
                    'desc' => \Joomla\CMS\Language\Text::_('Set the grid gutter width.'),
                    'values' => array(
                        'auto' => \Joomla\CMS\Language\Text::_('Auto'),
                        '1-1' => \Joomla\CMS\Language\Text::_('1 Column'),
                ...
                'columns_mobile' => array(
                    'type' => 'select',
                    'title' => \Joomla\CMS\Language\Text::_('Columns Mobile'),
                    'desc' => \Joomla\CMS\Language\Text::_('Set the grid gutter width.'),
                    'values' => array(
                        'auto' => \Joomla\CMS\Language\Text::_('Auto'),
                        '1-1' => \Joomla\CMS\Language\Text::_('1 Column'),
				...
				'gutter' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Gutter'),
					'desc' => \Joomla\CMS\Language\Text::_('Set the grid gutter width.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Default'),
				...
				'alignment_breakpoint' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Define the device width from which the alignment will applly'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Always'),
						's' => \Joomla\CMS\Language\Text::_('Small (Phone Landscape)'),
						'm' => \Joomla\CMS\Language\Text::_('Medium (Tablet Landscape)'),
