...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uileaderprice',
		'title' => \Joomla\CMS\Language\Text::_('UI Leader Pricing'),
		'desc' => \Joomla\CMS\Language\Text::_('Price List module to design pixel-perfect menus, catalogs, product list or any other list of featured items.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uileaderprice/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'title' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Add title for Leader pricing box'),
					'std' =>  'Today’s Special',
				),
				// Repeatable Items
				'ui_pricelist_item' => array(
					...
					'attr' => array(
						'item_name' => array(
							'type' => 'text',
							'title' => \Joomla\CMS\Language\Text::_('Title'),
							'desc' => \Joomla\CMS\Language\Text::_('Define the title for menu item'),
							'std' => 'Seafood with Rice & Salad',
						),
						'item_price' => array(
							'type' => 'text',
							'title' => \Joomla\CMS\Language\Text::_('Price'),
							'desc' => \Joomla\CMS\Language\Text::_('Define the price for item'),
							'std' => '$20.90',
						),
					),
				),
                ...
                'custom_card_color' => array(
                    'type' => 'color',
                    'title' => \Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_GLOBAL_COLOR'),
                    'depends' => array(
                        array('card_styles', '=', 'custom')
                    ),
                ),
                'custom_card_background' => array(
                    'type' => 'color',
                ...
                'custom_card_border_color' => array(
                    'type' => 'color',
                ...
                'custom_card_border_radius' => array(
                    'type' => 'slider',
                ...
                'custom_card_box_shadow'=>array(
                    'type'=>'boxshadow',
                    'title'=>\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_GLOBAL_BOXSHADOW'),
                    'depends' => array(
                        array('card_styles', '=', 'custom')
                    ),
                    'std'=>'0 0 0 0 #fff',
                ...
                'background_image'=>array(
                    'type'=>'media',
                    'title'=>\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_GLOBAL_BACKGROUND_IMAGE'),
                ),
				'card_size' => array(
					'type' => 'select',
				...
				'fill_character' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Fill character'),
					'desc' => \Joomla\CMS\Language\Text::_('To change the dot to any custom character'),
					'std' => '.'
				),
				...
				'title_position' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Title Position'),
