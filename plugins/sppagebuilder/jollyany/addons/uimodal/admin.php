...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uimodal',
		'title' => \Joomla\CMS\Language\Text::_('UI Modal'),
		'desc' => \Joomla\CMS\Language\Text::_('Create modal dialogs with different styles and transitions.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uimodal/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'separator_modal_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Modal Selector'),
				),
				'modal_selector' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Modal Selector'),
					'desc' => \Joomla\CMS\Language\Text::_('Select a type of modal selector from the below list'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Button'),
						'image_selector' => \Joomla\CMS\Language\Text::_('Image'),
					),
					'std' => '',
				),
				...
				'button_size' => array(
					...
					'values' => array(
						...
						'small' => \Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_SIZE_LARGE'),
						'large' => \Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_SIZE_XLARGE'),
					),
					'depends' => array(
						array('modal_selector', '!=', 'image_selector'),
					),
				...
				'separator_modal_content_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Modal Content'),
				),
				'modal_content_type' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Modal Content Type'),
					'desc' => \Joomla\CMS\Language\Text::_('Select the modal content type like text or image/video'),
					'values' => array(
						'text' => \Joomla\CMS\Language\Text::_('Text'),
						'image' => \Joomla\CMS\Language\Text::_('Image'),
						'video' => \Joomla\CMS\Language\Text::_('Html5 Video'),
						'youtube' => \Joomla\CMS\Language\Text::_('Youtube Video'),
						'vimeo' => \Joomla\CMS\Language\Text::_('Vimeo Video'),
					),
					'std' => 'text',
				),
				'modal_content_title' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Title'),
					'desc' => \Joomla\CMS\Language\Text::_('Create The Modal Title.'),
					'std' => 'Modal Popup',
				...
				'modal_content_text' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Insert modal content that will be displayed in modal popup window.'),
				...
				'modal_content_image' => array(
					'type' => 'media',
					'title' => \Joomla\CMS\Language\Text::_('Modal Image'),
					'desc' => \Joomla\CMS\Language\Text::_('Add image for content modal.'),
					'depends' => array('modal_content_type' => 'image'),
				),
				'modal_content_video_url_mp4' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Html5 Video MP4 URL'),
					'desc' => \Joomla\CMS\Language\Text::_('Add the mp4 video format. Example: https://quirksmode.org/html5/videos/big_buck_bunny.mp4'),
					'depends' => array('modal_content_type' => 'video'),
				),
				'modal_content_video_url_ogv' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Html5 Video OGV URL'),
					'desc' => \Joomla\CMS\Language\Text::_('Add the ogv video format. Example: https://quirksmode.org/html5/videos/big_buck_bunny.ogv'),
					'depends' => array('modal_content_type' => 'video'),
				),
				'modal_content_video_youtube_url' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Youtube Video ID'),
					'desc' => \Joomla\CMS\Language\Text::_('The unique Youtube ID. Example: https://www.youtube.com/watch?v=usnlMCcuex8 so the Unique ID is: usnlMCcuex8'),
					'depends' => array('modal_content_type' => 'youtube'),
				),
				'modal_content_video_vimeo_url' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Vimeo Video ID'),
					'desc' => \Joomla\CMS\Language\Text::_('The unique Vimeo video ID. Example: https://player.vimeo.com/video/1084537 so the Unique ID is: 1084537'),
					'depends' => array('modal_content_type' => 'vimeo'),
				),
				'muted_video' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Automute Video'),
					'std' => 0,
					'depends' => array(
				...
				'center_modal' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Center modal'),
					'values' => array(
						'0' => \Joomla\CMS\Language\Text::_('No'),
						'1' => \Joomla\CMS\Language\Text::_('Yes'),
					),
					'std' => '0',
				),
