...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('Heading Highlighted'),
		'desc' => \Joomla\CMS\Language\Text::_('Define different styles for heading highlighted.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uiheadinghighlighted/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'title' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Highlighted Text'),
					'desc' => \Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_TITLE_DESC'),
				...
				'heading_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Highlight Effect'),
					'desc' => \Joomla\CMS\Language\Text::_('Create attractive headlines that help keep your visitors interested and engaged'),
					'values' => array(
						'circle' => \Joomla\CMS\Language\Text::_('Circle'),
						'curly-line' => \Joomla\CMS\Language\Text::_('Curly Line'),
						'double' => \Joomla\CMS\Language\Text::_('Double'),
						'double-line' => \Joomla\CMS\Language\Text::_('Double Line'),
						'zigzag' => \Joomla\CMS\Language\Text::_('Zigzag'),
						'diagonal' => \Joomla\CMS\Language\Text::_('Diagonal'),
						'underline' => \Joomla\CMS\Language\Text::_('Underline'),
						'delete' => \Joomla\CMS\Language\Text::_('Delete'),
						'strike' => \Joomla\CMS\Language\Text::_('Strikethrough'),
					),
					'std' => 'circle',
				),
                ...
                'title_highlight_color' => array(
                    'type' => 'color',
                    'title' => \Joomla\CMS\Language\Text::_('Highlight Color'),
                ),
				...
				'title_lineheight' => array( 
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Line Height'),
					'std' => '',
					'max' => 200,
				),
				'text_transform' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Text transform'),
				...
				'shapes_width' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Shapes Width'),
					'std' => '9',
					'max' => 100,
				),
				'color' => array(
					'type' => 'color',
					'title' => \Joomla\CMS\Language\Text::_('Shapes Color'),
				),
				'use_link' => array(
					'type' => 'checkbox',
