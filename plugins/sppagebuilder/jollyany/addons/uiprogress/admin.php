...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('UI Progress'),
		'desc' => \Joomla\CMS\Language\Text::_('Defines progress bars that indicate how far along a process is.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uiprogress/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'progress_value' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Progress'),
					'desc' => \Joomla\CMS\Language\Text::_('Defines progress bar value'),
					'std' => 80,
					'min' => 1,
					'max' => 100,
				),
				'separator_bar_style_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Bar'),
				),
				...
				'heading_style' => array(
					...
					'values' => array(
						...
						'heading-xlarge' => \Joomla\CMS\Language\Text::_('X-Large'),
				...
				'decoration' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Title Decoration'),
					...
					'values' => array(
						...
						'bullet' => \Joomla\CMS\Language\Text::_('Bullet'),
						'line' => \Joomla\CMS\Language\Text::_('Line'),
					),
					'std' => '',
				),
                ...
                'title_position' => array(
                    ...
                    'desc' => \Joomla\CMS\Language\Text::_('Display title on top or after progress'),
                    'values' => array(
