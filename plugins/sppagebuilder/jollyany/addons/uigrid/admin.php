...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uigrid',
		'title' => \Joomla\CMS\Language\Text::_('UI Grid'),
		'desc' => \Joomla\CMS\Language\Text::_('Create grid content with Masonry effect, filter navigation and more.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uigrid/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'ui_grid_item' => array(
					...
					'attr' => array(
						...
						'label_text' => array(
							...
							'desc' => \Joomla\CMS\Language\Text::_('To position a badge inside a grid item.'),
							'std' => '',
						),
						'label_styles' => array(
							'type' => 'select',
						...
						'tag_name' => array(
							'type' => 'text',
							'title' => \Joomla\CMS\Language\Text::_('Tag Name'),
							'desc' => \Joomla\CMS\Language\Text::_('Enter a comma-separated list of tags, for example: blue, white, black.'),
							'std' => '',
						),
					),
				),
				...
				'separator_filter_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Filter'),
				),
				'enable_filter' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Enable filter navigation'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'filter_reverse' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Reverse order'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'filter_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Select the filter style. The pill and divider styles are only available for horizontal subnavs'),
					'values' => array(
				...
				'filter_control' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Show filter control for all items'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'all_control' => array(
					'type' => 'text',
					'std' => '',
					'title' => \Joomla\CMS\Language\Text::_('All Items'),
					'desc' => \Joomla\CMS\Language\Text::_('Show filter control for all items'),
					'placeholder' => 'All',
					'depends' => array('enable_filter' => 1),
				),
				'positions' => array(
				...
				'filter_grid_column_gap' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Set the size of the gap between between the filter navigation and the content.'),
					'values' => array(
						'small' => \Joomla\CMS\Language\Text::_('Small'),
						'medium' => \Joomla\CMS\Language\Text::_('Medium'),
						'' => \Joomla\CMS\Language\Text::_('Default'),
				...
				'show_lightbox_title' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Display the title inside the panel, as the lightbox caption or both.'),
					'values' => array(
				...
				'show_lightbox_content' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Display the content inside the panel, as the lightbox caption or both.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Overlay + Lightbox'),
				...
				'separator_divider_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Divider Style'),
					'depends' => array(
				...
				'divider_border_width' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Border Width'),
					'min' => 1,
					'max' => 10,
					'depends' => array(
						array('grid_divider', '=', 1),
				...
				'divider_border_color' => array(
					'type' => 'color',
					'title' => \Joomla\CMS\Language\Text::_('Border color'),
					'depends' => array(
						array('grid_divider', '=', 1),
						array('grid_column_gap', '!=', 'collapse'),
						array('grid_row_gap', '!=', 'collapse')
