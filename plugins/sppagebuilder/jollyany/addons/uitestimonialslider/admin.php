...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uitestimonialslider',
		'title' => \Joomla\CMS\Language\Text::_('UI Testimonial Slider'),
		'desc' => \Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_DESC'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uitestimonialslider/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'ui_testimonialslider_item' => array(
					...
					'attr' => array(
						...
						'avatar' => array(
							'type' => 'media',
							'title' => \Joomla\CMS\Language\Text::_('Avatar'),
						...
						'client_review' => array(
							'type' => 'select',
							'title' => \Joomla\CMS\Language\Text::_('Client Rating'),
							'values' => array(
								'' => \Joomla\CMS\Language\Text::_('None'),
								'1' => \Joomla\CMS\Language\Text::_('1'),
								'2' => \Joomla\CMS\Language\Text::_('2'),
								'3' => \Joomla\CMS\Language\Text::_('3'),
								'4' => \Joomla\CMS\Language\Text::_('4'),
								'5' => \Joomla\CMS\Language\Text::_('5'),
							),
							'std' => '',
						),
						'message' => array(
				...
				'separator_testimonial_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Testimonial'),
				),
				'header_alignment' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Header Position'),
					'values' => array(
				...
				'icon_color' => array(
					'type' => 'color',
					'title' => \Joomla\CMS\Language\Text::_('Rating Icon Color'),
					'std' => '#fba311',
				),
				'icon_rating' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Rating Icon Type'),
					'values' => array(
				...
				'rating_alignment' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Rating Position'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Default'),
						'image' => \Joomla\CMS\Language\Text::_('Below Image'),
					),
					'std' => '',
				),
				...
				'slidesets' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Group items into sets. The number of items within a set depends on the defined item width, e.g. 33% means that eaach set contains 3 items.'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'autoplay' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Enable autoplay'),
				...
				'image_position' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Display image above/below/inline/ testimonial content or none.'),
					'values' => array(
				...
				'title_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Name Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Heading styles differ in font-size but may also come with a predefined color, size and font'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
						'heading-2xlarge' => \Joomla\CMS\Language\Text::_('2XLarge'),
				...
				'title_text_color' => array(
					...
					'values' => array(
						...
						'warning' => \Joomla\CMS\Language\Text::_('Warning'),
						'danger' => \Joomla\CMS\Language\Text::_('Danger'),
						'background' => \Joomla\CMS\Language\Text::_('Background'),
					),
					'std' => '',
				),
