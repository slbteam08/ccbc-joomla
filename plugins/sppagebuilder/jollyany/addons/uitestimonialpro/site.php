...
class SppagebuilderAddonUITestimonialpro extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        if($show_quote){
            $output .= '<span uk-icon="icon: quote-right; width: '.$icon_size.';"></span>';
        }
        ...
        if($arrow_controls) {
			$output	.= '<a href="#sppb-testimonial-pro-'. $this->addon->id .'" class="left sppb-carousel-control" data-slide="prev" aria-label="'.\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ARIA_PREVIOUS').'"><i aria-hidden="true" class="fa '.$left_arrow.'"></i></a>';
			$output	.= '<a href="#sppb-testimonial-pro-'. $this->addon->id .'" class="right sppb-carousel-control" data-slide="next" aria-label="'.\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ARIA_NEXT').'"><i aria-hidden="true" class="fa '.$right_arrow.'"></i></a>';
		}
    ...
    public function css() {
        ...
        if($icon_style){
            $css .= '#sppb-addon-' . $this->addon->id . ' .sppb-testimonial-pro .uk-icon{ ' . $icon_style . ' }';
        }
        //Content style
        $content_style ='';
