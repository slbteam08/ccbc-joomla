...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uiimage',
		'title' => \Joomla\CMS\Language\Text::_('UI Image'),
		'desc' => \Joomla\CMS\Language\Text::_('Create an image which comes in different styles.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uiimage/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'title_position' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_TITLE_POSITION'),
					'values' => array(
                ...
                'image_webp_enable' => array(
                    'type' => 'checkbox',
                    'title' => \Joomla\CMS\Language\Text::_('Enable WebP Type'),
                    'desc' => \Joomla\CMS\Language\Text::_('Use WebP image type.'),
                    'std' => 0,
                ),
                'image_webp' => array(
                    'type' => 'media',
                    'title' => \Joomla\CMS\Language\Text::_('Select WebP Image'),
                    'show_input' => true,
                    'placeholder' => 'http://www.example.com/my-photo.jpg',
				...
				'image_blend_modes' => array(
					...
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
						'uk-blend-multiply' => \Joomla\CMS\Language\Text::_('Multiply'),
						'uk-blend-screen' => \Joomla\CMS\Language\Text::_('Screen'),
						'uk-blend-overlay' => \Joomla\CMS\Language\Text::_('Overlay'),
						'uk-blend-darken' => \Joomla\CMS\Language\Text::_('Darken'),
						'uk-blend-lighten' => \Joomla\CMS\Language\Text::_('Lighten'),
						'uk-blend-color-dodge' => \Joomla\CMS\Language\Text::_('Color Dodge'),
						'uk-blend-color-burn' => \Joomla\CMS\Language\Text::_('Color Burn'),
						'uk-blend-hard-light' => \Joomla\CMS\Language\Text::_('Hard Light'),
						'uk-blend-soft-light' => \Joomla\CMS\Language\Text::_('Soft Light'),
						'uk-blend-difference' => \Joomla\CMS\Language\Text::_('Difference'),
						'uk-blend-exclusion' => \Joomla\CMS\Language\Text::_('Exclusion'),
						'uk-blend-hue' => \Joomla\CMS\Language\Text::_('Hue'),
						'uk-blend-color' => \Joomla\CMS\Language\Text::_('Color'),
						'uk-blend-luminosity' => \Joomla\CMS\Language\Text::_('Luminosity'),
					),
					'std' => '',
					'depends'=>array(
						array('image_panel', '=', 1),
				...
				'link_type' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Link Type'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
						'use_link' => \Joomla\CMS\Language\Text::_('Link'),
						'use_modal' => \Joomla\CMS\Language\Text::_('Modal'),
					),
					'std' => '',
					'depends' => array(array('image', '!=', '')),
				),
