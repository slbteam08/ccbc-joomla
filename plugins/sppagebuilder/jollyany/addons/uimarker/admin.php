...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uimarker',
		'title' => \Joomla\CMS\Language\Text::_('UI Marker'),
		'desc' => \Joomla\CMS\Language\Text::_('Create a marker icon that can be displayed on top of images.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uimarker/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'alt_text' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Enter the image\'s alt attribute.'),
					'std' => 'Image Alt',
					'depends' => array(
						array('image', '!=', ''),
					),
				...
				'ui_list_marker_item' => array(
					...
					'attr' => array(
						'left_space' => array(
							'type' => 'slider',
							'title' => \Joomla\CMS\Language\Text::_('Left'),
							'min' => 0,
							'max' => 100,
							'desc' => \Joomla\CMS\Language\Text::_('Enter the horizontal position of the marker in percent'),
							'std' => '50',
						),
						'top_space' => array(
							'type' => 'slider',
							'title' => \Joomla\CMS\Language\Text::_('Top'),
							'min' => 0,
							'max' => 100,
							'desc' => \Joomla\CMS\Language\Text::_('Enter the vertical position of the marker in percent.'),
							'std' => '50',
						),
						'marker_title' => array(
							'type' => 'text',
						...
						'marker_position' => array(
							...
							'desc' => \Joomla\CMS\Language\Text::_('Select a different position for this item.'),
							'values' => array(
								'' => \Joomla\CMS\Language\Text::_('None'),
								'top-center' => \Joomla\CMS\Language\Text::_('Top'),
								'bottom-center' => \Joomla\CMS\Language\Text::_('Bottom'),
								'left-center' => \Joomla\CMS\Language\Text::_('Left'),
								'right-center' => \Joomla\CMS\Language\Text::_('Right'),
							),
							'std' => '',
						),
					),
				...
				'separator_style_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Popover'),
				),
				'popover_mode' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Mode'),
					'desc' => \Joomla\CMS\Language\Text::_('Display the popover on click or hover'),
					'values' => array(
						'hover' => \Joomla\CMS\Language\Text::_('Hover'),
						'click' => \Joomla\CMS\Language\Text::_('Click'),
					),
					'std' => 'hover'
				),
				'popover_position' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Position'),
					'desc' => \Joomla\CMS\Language\Text::_('Select the popover\'s alignment to its marker. If the popover doesn\'t fit its container, it will flip automatically.'),
					'values' => array(
						'top-center' => \Joomla\CMS\Language\Text::_('Top'),
						'bottom-center' => \Joomla\CMS\Language\Text::_('Bottom'),
						'left-center' => \Joomla\CMS\Language\Text::_('Left'),
				...
				'popover_width' => array(
					...
					'min' => 0,
					'max' => 1000,
					'desc' => \Joomla\CMS\Language\Text::_('Enter a width for the popover in pixel'),
					'placeholder' => '300',
				),
				'popover_animation' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Animation'),
					'desc' => \Joomla\CMS\Language\Text::_('Apply the animations effect to the dropdown on hover/click'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
				...
				'card_styles' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Select a card style.'),
					'values' => array(
				...
				'mobile_switcher' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Enable Mobile Switcher'),
					'desc' => \Joomla\CMS\Language\Text::_('Use switcher mode on mobile devices to navigate between maker items.'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'heading_style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Title styles differ in font-size but may also come with a predefined color, size and font.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
						'heading-small' => \Joomla\CMS\Language\Text::_('Small'),
						'h1' => \Joomla\CMS\Language\Text::_('H1'),
				...
				'title_decoration' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Decoration'),
					'desc' => \Joomla\CMS\Language\Text::_('Decorate the title with a divider, bullet or a line that is vertically centered to the heading.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
						'uk-heading-divider' => \Joomla\CMS\Language\Text::_('Divider'),
						'uk-heading-bullet' => \Joomla\CMS\Language\Text::_('Bullet'),
				...
				'image_padding' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Attach the image to the drop\'s edge.'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
