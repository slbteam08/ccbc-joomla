...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'repeatable',
		'addon_name' => 'uitable',
		'title' => \Joomla\CMS\Language\Text::_('UI Table'),
		'desc' => \Joomla\CMS\Language\Text::_('Easily create nice looking tables, which come in different styles.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uitable/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'ui_table_item' => array(
					...
					'attr' => array(
						...
						'button_title' => array(
							'type' => 'text',
							'title' => \Joomla\CMS\Language\Text::_('Button Title'),
				...
				'separator_table_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Table'),
				),
				'style' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Style'),
					'desc' => \Joomla\CMS\Language\Text::_('Select the table style, default, divider or striped row style.'),
					'values' => array(
				...
				'highlight_row' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Highlight the hovered row'),
					'values' => array(
				...
				'remove_left_right_padding' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Remove left and right padding'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'order' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Order'),
					'desc' => \Joomla\CMS\Language\Text::_('Define the order of the table cells.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Meta, Image, Title, Content, Link'),
						'2' => \Joomla\CMS\Language\Text::_('Title, Image, Meta, Content, Link'),
						'3' => \Joomla\CMS\Language\Text::_('Image, Title, Content, Meta, Link'),
						'4' => \Joomla\CMS\Language\Text::_('Image, Title, Meta, Content, Link'),
						'5' => \Joomla\CMS\Language\Text::_('Title, Meta, Content, Link, Image'),
						'6' => \Joomla\CMS\Language\Text::_('Meta, Title, Content, Link, Image'),
					),
					'std' => '',
				),
				'vertical_alignment' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Vertically center table cells.'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'responsive' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Responsive'),
					'desc' => \Joomla\CMS\Language\Text::_('Stack columns on small devices or enable overflow scroll for the container.'),
					'values' => array(
						'overflow' => \Joomla\CMS\Language\Text::_('Scroll overflow'),
						'responsive' => \Joomla\CMS\Language\Text::_('Stacked'),
					),
					'std' => 'overflow'
				),
				'table_width_title' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Title Width'),
					'desc' => \Joomla\CMS\Language\Text::_('Define the width of the title cell.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Expand'),
						'shrink' => \Joomla\CMS\Language\Text::_('Shrink'),
						'small' => \Joomla\CMS\Language\Text::_('Small'),
				...
				'table_width_meta' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Meta Width'),
					'desc' => \Joomla\CMS\Language\Text::_('Define the width of the meta cell.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Expand'),
						'shrink' => \Joomla\CMS\Language\Text::_('Shrink'),
						'small' => \Joomla\CMS\Language\Text::_('Small'),
				...
				'table_width_content' => array(
					'type' => 'select',
					'title' => \Joomla\CMS\Language\Text::_('Content Width'),
					'desc' => \Joomla\CMS\Language\Text::_('Define the width of the content cell.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('Expand'),
						'shrink' => \Joomla\CMS\Language\Text::_('Shrink'),
						'small' => \Joomla\CMS\Language\Text::_('Small'),
				...
				'separator_head_options' => array(
					'type' => 'separator',
					'title' => \Joomla\CMS\Language\Text::_('Table Head'),
				),
				...
				'title' => array(
					...
					'title' => \Joomla\CMS\Language\Text::_('Title'),
					'placeholder' => 'Title',
					'desc' => \Joomla\CMS\Language\Text::_('Enter a table header text for the title column'),
				),
				'meta' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Meta'),
					'placeholder' => 'Meta',
					'desc' => \Joomla\CMS\Language\Text::_('Enter a table header text for the meta column'),
				),
				'content' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Content'),
					'placeholder' => 'Content',
					'desc' => \Joomla\CMS\Language\Text::_('Enter a table header text for the content column'),
				),
				'image' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Image'),
					'placeholder' => 'Image',
					'desc' => \Joomla\CMS\Language\Text::_('Enter a table header text for the link column'),
				),
				'link' => array(
					'type' => 'text',
					'title' => \Joomla\CMS\Language\Text::_('Link'),
				...
				'separator_content_hide_options' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Show or hide content fields without the need to delete the content itself.'),
				),
				'hide_title' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Hide the title'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'hide_meta' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Hide the meta text'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'hide_content' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Hide the content'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'hide_image' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Hide the image'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'hide_link' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Hide the link'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
				...
				'image_width' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Define image width'),
					'std' => '225',
					'min' => 120,
					'max' => 1200,
				),
				...
				'expand_width' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Expand width to table cell'),
					'values' => array(
						1 => \Joomla\CMS\Language\Text::_('JYES'),
						0 => \Joomla\CMS\Language\Text::_('JNO'),
					),
