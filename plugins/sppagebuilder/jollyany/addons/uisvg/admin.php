...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uisvg',
		'title' => \Joomla\CMS\Language\Text::_('UI Svg'),
		'desc' => \Joomla\CMS\Language\Text::_('Inject inline SVG images into the page markup and style them with CSS.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uisvg/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'image' => array(
					'type' => 'media',
					'title' => \Joomla\CMS\Language\Text::_('Svg Image'),
				...
				'preserve' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Preserve Color'),
					'desc' => \Joomla\CMS\Language\Text::_('SVGs will adapt the current color for their stroke and fill color. To prevent this behavior, you can use this option to add css class to the SVG itself or to elements inside the SVG.'),
					'std' => 0,
					'depends' => array(
						array('image', '!=', ''),
					),
				...
				'color' => array(
					'type' => 'color',
					'title' => \Joomla\CMS\Language\Text::_('Fill Color Svg'),
					'std' => '',
					'depends' => array(
						array('image', '!=', ''),
						array('preserve', '!=', 0),
				...
				'use_link' => array(
					'type' => 'checkbox',
					'title' => \Joomla\CMS\Language\Text::_('Use Link'),
					'desc' => \Joomla\CMS\Language\Text::_('Check this option to insert the link for svg image.'),
					'std' => 0
				),
