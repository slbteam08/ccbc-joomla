...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('UI Divider'),
		'desc' => \Joomla\CMS\Language\Text::_('Create dividers to separate content and apply different styles to them.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uidivider/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'divider_type' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Choose a divider style.'),
					'values' => array(
						'uk-hr' => \Joomla\CMS\Language\Text::_('Default'),
						'uk-divider-icon' => \Joomla\CMS\Language\Text::_('Icon'),
						'uk-divider-small' => \Joomla\CMS\Language\Text::_('Small'),
						'uk-divider-vertical' => \Joomla\CMS\Language\Text::_('Vertical'),
					),
					'std' => 'uk-hr',
				),
				'html_selector' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Choose the divider element to fit your semantic structure. Use the hr element for a thematic break and the div element for decorative reasons.'),
					'values' => array(
						'hr' => 'Hr',
						'div' => 'Div'
					),
				...
				'border_width' => array(
					'type' => 'slider',
					'title' => \Joomla\CMS\Language\Text::_('Border Top Width'),
					'min' => 1,
					'max' => 100,
					'depends' => array(
