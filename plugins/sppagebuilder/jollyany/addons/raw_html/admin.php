...
SpAddonsConfig::addonConfig(
	array(
		...
		'title'=>\Joomla\CMS\Language\Text::_('Custom Html'),
		'desc'=>\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_RAW_HTML_DESC'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/raw_html/assets/images/icon.png',
		'category'=>'General',
		'attr'=>array(
			'general' => array(
				'admin_label'=>array(
				...
				'html'=>array(
					'type'=>'textarea',
					'title'=>\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_RAW_HTML_HTML'),
					'desc'=>\Joomla\CMS\Language\Text::_('COM_SPPAGEBUILDER_ADDON_RAW_HTML_HTML_DESC'),
					'std'=>'',
				),
