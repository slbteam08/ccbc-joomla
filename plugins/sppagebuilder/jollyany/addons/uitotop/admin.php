...
SpAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'uitotop',
		'title' => \Joomla\CMS\Language\Text::_('UI To Top'),
		'desc' => \Joomla\CMS\Language\Text::_('Create a simple Smooth to-top scroller.'),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uitotop/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				...
				'text_color' => array(
					...
					'desc' => \Joomla\CMS\Language\Text::_('Add predefined text color to totop icon.'),
					'values' => array(
						'' => \Joomla\CMS\Language\Text::_('None'),
