...
SpAddonsConfig::addonConfig(
	array(
		...
		'title' => \Joomla\CMS\Language\Text::_('UI Info Box'),
		'desc' => \Joomla\CMS\Language\Text::_('Use the Infobox Add-on that lets you add a heading prefix, heading, description, icon and more. '),
		'icon'=>\Joomla\CMS\Uri\Uri::root() . 'plugins/sppagebuilder/jollyany/addons/uiinfobox/assets/images/icon.png',
		'category' => 'Jollyany',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'ui_grid_item' => array(
					...
					'attr' => array(
						...
						'media_type' => array(
							...
							'desc' => \Joomla\CMS\Language\Text::_('Select icon or image info box type from the list'),
							'values' => array(
								'' => \Joomla\CMS\Language\Text::_('Image'),
								'fontawesome_icon' => \Joomla\CMS\Language\Text::_('FontAwesome Icon'),
								'uikit_icon' => \Joomla\CMS\Language\Text::_('Uikit Icon'),
								'custom' => \Joomla\CMS\Language\Text::_('Custom Icon'),
							),
							'std' => '',
						),
						'image' => array(
                ...
                'thumbnail' => array(
                    ...
                    'desc' => \Joomla\CMS\Language\Text::_('Display content in overlay background'),
                    'values' => array(
                        1 => \Joomla\CMS\Language\Text::_('JYES'),
                        0 => \Joomla\CMS\Language\Text::_('JNO'),
                    ),
