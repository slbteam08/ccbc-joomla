...
namespace Tassos\Framework\Conditions\Conditions\Date;
...
class Date extends DateBase
{
	...
	{
		\Tassos\Framework\Functions::fixDateOffset($rule['params']['publish_up']);
		\Tassos\Framework\Functions::fixDateOffset($rule['params']['publish_down']);
	}
}