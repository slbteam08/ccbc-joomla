...
class UpgradeToBundle extends Notice
{
	...
	protected function getActions()
	{
		...
		return '<a href="' . \Tassos\Framework\Functions::getUTMURL($url, 'UserNotice', 'UpgradeToBundle') . '" target="_blank" class="tf-notice-btn success">' . Text::_('NR_UPGRADE_NOW') . '</a>';
	}
	...
	protected function canRun()
	{
		...
		if ($details = \Tassos\Framework\Notices\Helper::getExtensionDetails($this->payload['license_data'], $this->payload['ext_element']))
		{
