...
class Notices
{
	...
	public function __construct($payload = [])
	{
		...
		$this->download_key = \Tassos\Framework\Functions::getDownloadKey();
	}
	...
	private function getBaseNotices()
	{
		...
		foreach ($base_notices as $key => $notice)
		{
			$class = '\Tassos\Framework\Notices\Notices\\' . $notice;
	...
	private function getLicensesBasedNoticesToShow()
	{
		...
		if (!$extension_data = \Tassos\Framework\Notices\Helper::getExtensionDetails($this->license_data, $this->ext_element))
		{
			return false;
		}
	...
	public function checkAndUpdateExtensionsData()
	{
		...
		$this->license_data = \Tassos\Framework\Helpers\License::getRemoteLicenseData($this->download_key);
