...
class JFormFieldNRInlineFileUpload extends NRFormField
{
	...
	private function onUpload()
	{
		...
		try {
			$uploaded_file = Tassos\Framework\File::upload($file, JPATH_ROOT . DIRECTORY_SEPARATOR . $upload_folder, ['text/plain', 'text/csv'], false, true);
			$filePathInfo = Tassos\Framework\File::pathinfo($uploaded_file);
