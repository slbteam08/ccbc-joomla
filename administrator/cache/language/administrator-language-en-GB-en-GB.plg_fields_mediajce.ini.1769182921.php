...
return array (
  ...
  'PLG_FIELDS_MEDIAJCE_PARAMS_MEDIA_FOLDER_DESC' => 'Path where media files are located, relative to the File Directory Path set in the Editor Profile parameters.',
);
