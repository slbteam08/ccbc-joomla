            ...
            'fields' => [
                'sp_timeline_items' => [
                    ...
                    'attr'  => [
                        ...
                        'date' => [
                            'type'  => 'text',
                            'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_START_DATE'),
                            'std'   => '12 June 2030',
                        ],

                        'end_date' => [
                            'type'  => 'text',
                            'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_END_DATE'),
                        ],

                        'image' => [
                            'type' => 'media',
                            'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_TIMELINE_IMAGE'),
                        ],
                    ],
                ],
            ],
        ...
        'timeline_image' => [
            ...
            'fields' => [
                ...
                'image_shape' => [
                    ...
                    'values' => [
                        'sppb-image-sqaure' => Text::_('COM_SPPAGEBUILDER_GLOBAL_SQUARE'),
                        'sppb-image-round'  => Text::_('COM_SPPAGEBUILDER_GLOBAL_ROUNDED'),
                        'sppb-image-circle' => Text::_('COM_SPPAGEBUILDER_GLOBAL_CIRCLE'),
                    ],
                    'std' => 'sppb-image-round'
                ],
